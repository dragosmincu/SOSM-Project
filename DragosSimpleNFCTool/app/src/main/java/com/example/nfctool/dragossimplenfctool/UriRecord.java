...
public class UriRecord implements ParsedNdefRecord {
    ...
    // First bit meaning in a Uri record from a Ndef message
    // taken from Ndef specifications
    ...
    // this is generic evaluation

    // first byte from a record contains the tnf (last 3 bits only)
    // URL are stored in type WELL_KNOWN or ABSOLUTE_URI
    ...
    // for absolute, we just get the payload
    ...
    // for well known, the first payload byte defines a prefix type, apply this transformation
